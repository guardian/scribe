case $CIRCLE_NODE_INDEX in
  ...
  2) BROWSER_NAME='firefox' BROWSER_VERSION='33' PLATFORM='Windows XP' npm test ;;
  ...
  5) BROWSER_NAME='chrome'  BROWSER_VERSION='37' PLATFORM='Windows XP' npm test ;;
  6) BROWSER_NAME='chrome'  BROWSER_VERSION='38' PLATFORM='Windows XP' npm test ;;
esac
