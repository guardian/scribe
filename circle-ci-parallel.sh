case $CIRCLE_NODE_INDEX in
  0) BROWSER_NAME='firefox' BROWSER_VERSION='33' npm test ;;
  1) BROWSER_NAME='firefox' BROWSER_VERSION='34' npm test ;;
  2) BROWSER_NAME='firefox' BROWSER_VERSION='35' npm test ;;
